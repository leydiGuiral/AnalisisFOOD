              ...
              <div class="card">
                ...
                <div class="card-body">
                  <form action="formulario_registro.html" method="post">
                    ...
                    <div class="form-group">
                      <label for="register-empresa" style="color: white; text-shadow: -1px -1px 0 black, 1px -1px 0 black, -1px 1px 0 black, 1px 1px 0 black;"><h4>nombre empresa</h4></label>
                      <input type="empresa" id="register-empresa" class="form-control" required>
                    </div>
                    <div class="form-group">
